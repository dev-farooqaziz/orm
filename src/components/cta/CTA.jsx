...
const CTA = ({ text, href, black }) => {
    return (
        <>
            {black ?
                <a href="tel:123456789" className={`bg-black text-white h-[40px] lg:h-[50px] px-3 2xl:px-6 rounded-[7px] flex items-center gap-x-2`}>
                ...
                <>
                    {href ?
                        <div dangerouslySetInnerHTML={{
                            __html:
                            `
                                <a href=${href} class="bg-primary text-white border-0 h-[40px] lg:h-[50px] px-3 2xl:px-6 rounded-[7px] flex items-center"> 
