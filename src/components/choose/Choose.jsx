                    ...
                    <div className="grid grid-cols-12 items-center gap-5">
                        ...
                        <div className="col-span-12 lg:col-span-6 xl:col-span-4">
                            <div className="relative">
                                ...
                                <div className="flex flex-col items-center justify-center gap-3 pt-5 pb-[40px] absolute top-0 left-[-5%] lg:left-[-5%] h-full">
                                    <h3 className="text-[25px] sm:text-[40px] leading-tight tracking-wide font-semibold font-poppins text-white text-center">
                                        75%
                                        <span className="block text-[20px] tracking-wide font-montserrat font-medium text-center text-white">
                                            Verified Reviews
                                        </span>
                                    </h3>
                                    <p className="w-[85%] md:w-[80%] mx-auto text-[14px] sm:text-[16px] tracking-wide leading-normal lg:leading-tight font-montserrat font-medium text-center text-white">
                        ...
                        <div className="col-span-12 lg:col-span-6 xl:col-span-4">
                            <div className="relative">
                                ...
                                <div className="flex flex-col items-center justify-center gap-3 pt-5 pb-[40px] absolute top-0 left-[-5%] h-full">
                                    <Image src={support} alt="ORM" className="w-[25%] mb-2 sm:mb-4" />
                                    <h3 className="text-[25px] sm:text-[40px] leading-tight tracking-wide font-semibold font-poppins text-black">
                                        24/7
                                        <span className="block text-[20px] tracking-wide font-montserrat font-medium text-center text-black">
                                            Support
                                        </span>
                                    </h3>
                                    <p className="w-[80%] mx-auto text-[14px] sm:text-[16px] tracking-wide leading-normal lg:leading-tight font-montserrat font-medium text-center text-black">
                        ...
                        <div className="col-span-12 lg:col-span-6 xl:col-span-4">
                            <div className="relative">
                                ...
                                <div className="flex flex-col items-center justify-center gap-3 pt-5 pb-[40px] absolute top-0 left-[-5%] h-full">
                                    <h3 className="text-[25px] sm:text-[40px] leading-tight tracking-wide font-semibold font-poppins text-white">
                                        Verified
                                        <span className="block text-[20px] tracking-wide font-montserrat font-medium text-center text-white">
                                            for Trust
                                        </span>
                                    </h3>
                                    <p className="w-[80%] mx-auto text-[14px] sm:text-[16px] tracking-wide leading-normal lg:leading-tight font-montserrat text-center text-white">
