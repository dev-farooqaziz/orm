...
const Billboard = ({ content }) => {
    ...
    return (
        <>
            <section className="flex items-center py-12 lg:py-20 relative z-10 overflow-hidden">
                <Image src={foldBg} alt="ORM" quality={100} priority={true} placeholder="blur" fill={true} className="block -z-10 object-cover object-bottom" />
                <div className="container">
                    <div className="grid grid-cols-12 gap-5">
                        <div className="col-span-12 md:col-span-8 lg:col-span-6 xl:col-span-5">
                            <div className="bg-black/50 backdrop-blur-lg rounded-[25px] overflow-hidden px-6 py-8 md:px-8 md:py-12">
                                ...
                                <div className="flex gap-5 md:gap-10 mt-5 xl:mt-8">
